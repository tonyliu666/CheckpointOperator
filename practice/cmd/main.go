...
import (
	...
	"tony123.tw/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0c941f82.my.domain",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&apiv1alpha1.Migration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Migration")
			os.Exit(1)
		}
	}
	if err = (&controller.NodeMonitorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "NodeMonitor")
		os.Exit(1)
	}
